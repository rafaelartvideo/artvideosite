                ...
                {createForm.customerType === "PF" ? <>
                  <div>
                    ...
                    <div className="flex min-w-0 items-center gap-2">
                      ...
                      <AdminButton variant="secondary" size="sm" onClick={() => void lookupCreateCpf(createForm.document)} disabled={saving || cpfLoading || !isValidCpf(createForm.document)} className="h-[42px] shrink-0 border-[#0057e7]/30 px-3 text-[#0057e7] hover:bg-[#0057e7]/5" aria-label="Consultar CPF" title="Consultar CPF">

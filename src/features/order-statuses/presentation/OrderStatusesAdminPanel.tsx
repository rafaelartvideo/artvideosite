...
function OrderStatusesAdminPanelContent({ routeResourceId, routeSubpage, onRouteChange }: OrderStatusesAdminPanelProps) {
  ...
  return <div className="min-w-0 space-y-5">
    ...
    {delId && <ConfirmDialog message="Excluir este status? O histórico relacionado pode impedir a exclusão." onConfirm={() => remove(delId).finally(() => setDelId(null))} onCancel={() => setDelId(null)} />}

...
export function AgendaCalendarView(props: Props) {
  ...
  if (props.view === "day") {
    return <AdminCard className="min-h-[420px] p-4" {...dropZoneProps(props.cursor)}>{eventsFor(props.cursor).map(eventCard)}</AdminCard>;
  }

  if (props.view === "week") {
    return <AdminCard className="overflow-x-auto"><div className="grid min-w-[720px] grid-cols-7">
  ...
  return <AdminCard className="overflow-x-auto">

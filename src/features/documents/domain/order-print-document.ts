...
export function renderOrderPrintDocument(popup: Window, template: PrintTemplateEditorValue, context: PrintOrderContext) {
  ...
  const html = "<!doctype html><html><head><meta charset='utf-8'><title>" + escapeHtml(template.name) + "</title><style>" +
    ...
    "*{box-sizing:border-box}body{margin:0;color:#0f172a;font-family:Arial,sans-serif;font-size:11px}.header{display:flex;justify-content:space-between;gap:20px;border-bottom:2px solid #0d1b2e;padding-bottom:12px;margin-bottom:16px}.brand{font-size:20px;font-weight:900}.muted{color:#64748b}.document{text-align:right}.document h1{margin:0;font-size:19px}.document p{margin:4px 0 0}section{margin:0 0 14px;break-inside:avoid}h2{margin:0 0 7px;padding-bottom:5px;border-bottom:1px solid #cbd5e1;font-size:11px;text-transform:uppercase;letter-spacing:.08em}.grid{display:grid;gap:8px 14px}.columns-1{grid-template-columns:1fr}.columns-2{grid-template-columns:repeat(2,minmax(0,1fr))}.columns-3{grid-template-columns:repeat(3,minmax(0,1fr))}.field{min-width:0}.field span{display:block;color:#64748b;font-size:8px;font-weight:700;text-transform:uppercase;margin-bottom:2px}.field strong{display:block;white-space:normal;overflow-wrap:anywhere;font-size:11px}.footer{display:flex;justify-content:space-between;border-top:1px solid #cbd5e1;padding-top:8px;margin-top:16px;color:#64748b;font-size:9px}@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact}}" +

...
export type PartRequestForReview = { id: string; service_order_id: string; purpose?: "TEST" | "RESOLUTION" | null; status: string; notes: string | null; reviewed_by?: string | null; reviewed_at?: string | null; review_notes?: string | null; created_at: string; requester?: { full_name: string | null } | null; requested_by_profile?: { full_name: string | null } | null; reviewed_by_profile?: { full_name: string | null } | null; items: PartRequestItemForReview[] };
export type TestResultRow = { id: string; requestItemId: string; action: "RETURN" | "USE_IN_RESOLUTION" | "DAMAGED"; quantity: string; notes: string };

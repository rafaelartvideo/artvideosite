...
export function OSSituationsView({ onBack }: { onBack: () => void }) {
  ...
  const save = async () => {
    ...
    try {
      ...
      setDrawerOpen(false); setToast({ msg: editItem ? "Situação atualizada." : "Situação criada.", type: "success" }); await refresh();

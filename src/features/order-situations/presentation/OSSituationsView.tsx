...
export function OSSituationsView({ onBack, routeResourceId, routeSubpage, onRouteChange }: OSSituationsViewProps) {
  ...
  const save = async () => {
    ...
    try {
      ...
      closeEditor(); setToast({ msg: editItem ? "Situação atualizada." : "Situação criada.", type: "success" }); await refresh();

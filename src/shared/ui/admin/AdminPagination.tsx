...
export function PaginationBar({ page, pageSize, totalItems, onPageChange, onPageSizeChange }: {
  ...
  const pageButton = "flex h-11 w-11 items-center justify-center rounded-lg border border-[#0d1b2e]/15 bg-white text-[#5a6a82] transition-colors disabled:cursor-not-allowed disabled:opacity-40 hover:bg-[#f5f7fa] sm:h-8 sm:w-8";
  return <div className="flex flex-col gap-3 border-t border-[#0d1b2e]/8 bg-[#f8fafc] px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
    <div className="flex items-center justify-between gap-2 text-xs text-[#5a6a82] sm:justify-start">
      <span>Linhas:</span>
    ...
    <div className="grid grid-cols-[44px_44px_1fr_44px_44px] items-center gap-2 sm:flex sm:justify-end">

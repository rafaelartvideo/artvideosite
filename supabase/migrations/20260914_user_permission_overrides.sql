...
-- Substitui atomicamente apenas as permissões individuais do usuário alvo. A
-- autorização é revalidada dentro do RPC sem SECURITY DEFINER e as policies da
-- tabela continuam sendo a segunda barreira.
